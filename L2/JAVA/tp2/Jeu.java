...
public class Jeu {
	...
	/**
	 *  @return "true" si les objets sont de même classe, "false" sinon. */
    public static boolean memeClasse(Object a, Object b) {
    ...
    public static boolean ObjZorkEgaux(ObjetZork obj1, ObjetZork obj2) {
        if (memeClasse(obj1, obj2)) {
            if ((obj1.getPoids() == obj2.getPoids()) && ((obj1.getTransportable() == obj2.getTransportable())
                    && (obj1.getDescription() == obj2.getDescription()))) {
                return true;
            } else {
                return false;
            }
